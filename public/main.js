...
// const api_url = `https://api.openbrewerydb.org/breweries?by_city=${city}`
...
//         li.innerHTML = breweries[i]
//         ul.appendChild(li)
//     }

//     for(let i = 0; i <brewing_url.length; i++){
//         let li = document.createElement('li')

//         li.innerHTML = brewing_url[i]
//         ul_URL.appendChild(li)
//     }
...
// Getting breweries by distance from your location
// Button asking to get coordinates of current location
    // will need onclick event for button
    // retrieved coordinates will be placed in variables 
    // variables will be added to API url retrieval